...
/**
 * Sidebar entry that opens the project-management page (`/projects`).
 * Sits alongside Search and Scheduled Tasks so the upload + manage flow
 * is reachable without typing the URL by hand.
 */
const SiderProjectsEntry: React.FC<SiderProjectsEntryProps> = ({
  ...
  if (collapsed) {
    return (
      <Tooltip {...siderTooltipProps} content={t('projects.pageTitle')} position='right'>
        <div
